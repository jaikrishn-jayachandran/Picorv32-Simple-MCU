module soc_top (clk_i,
 ...
 sg13g2_antennanp ANTENNA_1 (.A(\boot_wdata[5] ));
 sg13g2_antennanp ANTENNA_10 (.A(\s_wdata[61] ));
 sg13g2_antennanp ANTENNA_11 (.A(\boot_wdata[0] ));
 sg13g2_antennanp ANTENNA_12 (.A(\boot_wdata[0] ));
 sg13g2_antennanp ANTENNA_13 (.A(\boot_wdata[10] ));
 sg13g2_antennanp ANTENNA_14 (.A(\boot_wdata[11] ));
 sg13g2_antennanp ANTENNA_15 (.A(\boot_wdata[12] ));
 sg13g2_antennanp ANTENNA_16 (.A(\boot_wdata[16] ));
 sg13g2_antennanp ANTENNA_17 (.A(\boot_wdata[16] ));
 sg13g2_antennanp ANTENNA_18 (.A(\boot_wdata[2] ));
 sg13g2_antennanp ANTENNA_19 (.A(\boot_wdata[2] ));
 sg13g2_antennanp ANTENNA_2 (.A(\boot_wdata[9] ));
 sg13g2_antennanp ANTENNA_20 (.A(\boot_wdata[3] ));
 sg13g2_antennanp ANTENNA_21 (.A(\boot_wdata[3] ));
 sg13g2_antennanp ANTENNA_22 (.A(\boot_wdata[8] ));
 sg13g2_antennanp ANTENNA_23 (.A(\cpu_wstrb[1] ));
 sg13g2_antennanp ANTENNA_24 (.A(\s_araddr[10] ));
 sg13g2_antennanp ANTENNA_25 (.A(\s_araddr[10] ));
 sg13g2_antennanp ANTENNA_26 (.A(\s_araddr[10] ));
 sg13g2_antennanp ANTENNA_27 (.A(\s_araddr[1] ));
 sg13g2_antennanp ANTENNA_28 (.A(\s_araddr[29] ));
 sg13g2_antennanp ANTENNA_29 (.A(\s_araddr[29] ));
 sg13g2_antennanp ANTENNA_3 (.A(\boot_wdata[9] ));
 sg13g2_antennanp ANTENNA_30 (.A(\s_araddr[5] ));
 sg13g2_antennanp ANTENNA_31 (.A(\s_araddr[8] ));
 sg13g2_antennanp ANTENNA_32 (.A(\s_rdata[92] ));
 sg13g2_antennanp ANTENNA_33 (.A(\s_wdata[6] ));
 sg13g2_antennanp ANTENNA_34 (.A(\s_wvalid[0] ));
 sg13g2_antennanp ANTENNA_35 (.A(\s_wvalid[0] ));
 sg13g2_antennanp ANTENNA_36 (.A(\s_awaddr[21] ));
 sg13g2_antennanp ANTENNA_37 (.A(\s_awaddr[21] ));
 sg13g2_antennanp ANTENNA_4 (.A(boot_we));
 sg13g2_antennanp ANTENNA_5 (.A(\cpu_araddr[8] ));
 sg13g2_antennanp ANTENNA_6 (.A(\s_awaddr[25] ));
 sg13g2_antennanp ANTENNA_7 (.A(\s_awaddr[29] ));
 sg13g2_antennanp ANTENNA_8 (.A(\s_awaddr[31] ));
 sg13g2_antennanp ANTENNA_9 (.A(\s_wdata[61] ));
 ...
 picorv32_macro u_cpu (.clk_i(clknet_1_0__leaf_clk_i),
    ...
    \cpu_wstrb[1] ,
    \cpu_wstrb[0] }));
 interconnect_macro u_ic (.clk_i(clknet_1_1__leaf_clk_i),
    ...
    \s_wvalid[1] ,
    \s_wvalid[0] }));
 peripherals_macro u_periph0 (.clk_i(clknet_1_0__leaf_clk_i),
    .rst_ni(net294),
