...
set ::env(CURRENT_DEF) /home/jaikrishn/Documents/hardware/picorv32_axi4lite_port/phyisical_design/macros/interconnect/runs/run_1/53-odb-cellfrequencytables/interconnect_macro.def
set ::env(SAVE_GDS) /home/jaikrishn/Documents/hardware/picorv32_axi4lite_port/phyisical_design/macros/interconnect/runs/run_1/57-magic-streamout/interconnect_macro.gds
set ::env(SAVE_MAG_GDS) /home/jaikrishn/Documents/hardware/picorv32_axi4lite_port/phyisical_design/macros/interconnect/runs/run_1/57-magic-streamout/interconnect_macro.magic.gds
set ::env(SAVE_MAG) /home/jaikrishn/Documents/hardware/picorv32_axi4lite_port/phyisical_design/macros/interconnect/runs/run_1/57-magic-streamout/interconnect_macro.mag
set ::env(MACRO_GDS_FILES) ""
set ::env(DIE_AREA) "0.0 0.0 176.975 195.695"
set ::env(MAGTYPE) mag
