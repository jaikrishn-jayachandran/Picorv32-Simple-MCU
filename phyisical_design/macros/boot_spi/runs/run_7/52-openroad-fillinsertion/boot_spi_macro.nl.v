module boot_spi_macro (boot_done,
 ...
 sg13g2_nor4_1 _1155_ (.A(net140),
    ...
    .D(_0482_),
    .Y(_0144_));
 sg13g2_a21oi_1 _1156_ (.A1(net358),
    .A2(\u_spi.div_cnt[0] ),
    .Y(_0483_),
    .B1(\u_spi.div_cnt[1] ));
