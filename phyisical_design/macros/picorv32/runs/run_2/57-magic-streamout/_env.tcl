...
set ::env(CURRENT_DEF) /home/jaikrishn/Documents/hardware/picorv32_axi4lite_port/phyisical_design/macros/picorv32/runs/run_2/53-odb-cellfrequencytables/picorv32_macro.def
set ::env(SAVE_GDS) /home/jaikrishn/Documents/hardware/picorv32_axi4lite_port/phyisical_design/macros/picorv32/runs/run_2/57-magic-streamout/picorv32_macro.gds
set ::env(SAVE_MAG_GDS) /home/jaikrishn/Documents/hardware/picorv32_axi4lite_port/phyisical_design/macros/picorv32/runs/run_2/57-magic-streamout/picorv32_macro.magic.gds
set ::env(SAVE_MAG) /home/jaikrishn/Documents/hardware/picorv32_axi4lite_port/phyisical_design/macros/picorv32/runs/run_2/57-magic-streamout/picorv32_macro.mag
set ::env(MACRO_GDS_FILES) ""
set ::env(DIE_AREA) "0.0 0.0 605.75 624.47"
set ::env(MAGTYPE) mag
